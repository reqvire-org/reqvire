...
#### Details
Provide reports is the capability anchor for search, collect, coverage, traces, model, containment, resources, ontologies, submodels, lint, and export report contracts.
...
#### Details
Semantic model export is the capability anchor for collecting ontology and SHACL content, exporting Turtle/JSON-LD semantic artifacts, projecting Reqvire model context as RDF, and keeping semantic exports traceable to their Reqvire source elements.

Query behavior over RDF projections should be added later as a separate requirement or subfeature when the implementation actually supports it.
