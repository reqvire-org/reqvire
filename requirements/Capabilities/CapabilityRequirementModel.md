...
SHACL profile split from Reqvire Capability Ontology so ontology vocabulary remains first-class and semantic contracts carry closed-world constraints.
...
SHACL profile split from Reqvire Requirement Ontology so ontology vocabulary remains first-class and semantic contracts carry closed-world constraints.
...
SHACL profile split from Reqvire Semantic Contract Ontology so ontology vocabulary remains first-class and semantic contracts carry closed-world constraints.
