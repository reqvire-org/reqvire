...
### Test Capability Test Change Impact Reused Contract Context Specifications Requirements Md
...
#### Metadata
  * type: requirement
#### Relations
  * specify: [Test Capability](#test-capability-test-change-impact-reused-contract-context-specifications-requirements-md)
...
### Independent Requirement With Same Reused Contract Context
...
Owner requirement for export format contract.
...
#### Relations
  * derivedFrom: [Independent Requirement With Same Reused Contract Context](#independent-requirement-with-same-reused-contract-context)
---
