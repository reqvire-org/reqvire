...
### Test Capability Test Element Type Relation Compatibility Invalid Contract Specifications
...
#### Relations
  * specify: [Test Capability](#test-capability-test-element-type-relation-compatibility-invalid-contract-specifications)
---

### Semantic Contract Ontology

Ontology vocabulary used by the invalid semantic-contract fixture.
...
#### Relations
  * constrain: [Requirement Refined By Semantic Contract](#requirement-defined-by-semantic-contract)
  * use: [Semantic Contract Ontology](#semantic-contract-ontology)
...
INVALID: Constraint (contract type) cannot have Relations subsection.
...
#### Relations
  * specifiedBy: [Target Capability](#target-capability)

---

### Behavior with DerivedFrom

INVALID: Behavior (contract type) cannot have Relations subsection.
...
INVALID: Specification (contract type) cannot have Relations subsection.
...
### Specification with SpecifiedBy
