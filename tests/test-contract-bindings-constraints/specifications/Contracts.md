...
#### Details
This contract is owned via definedBy relation, so it can be bound to requirements outside its defining hierarchy.
...
#### Details
This contract is used to verify reverse-direction contract_bindings flow between User Req A and User Req X hierarchies.
