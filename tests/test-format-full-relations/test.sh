...
#
# Test cases:
# 1. Basic inverse relation insertion (definedBy -> define)
...
# Check that Test Constraint does NOT have define: (auto-generated)
if grep -q "  \* define:" "$TEST_DIR/specifications/Requirements.md"; then
  echo "FAILED: Default format should NOT insert auto-generated define relations"
