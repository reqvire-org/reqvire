...
Capability with invalid refinement ownership.
...
Capability-owned ${refinement_type} is invalid.
...
assert_capability_owned_refinement_invalid "source" "Capability Source"
assert_capability_owned_refinement_invalid "constraint" "Capability Constraint"
assert_capability_owned_refinement_invalid "behavior" "Capability Behavior"
