...
const advancedPages = [
  ...
  },
  {
    ...
    desc: "Requirement implementation evidence, satisfiedBy links, attachment contract coverage, and JSON report shape.",
  },
  {
    name: "Submodels and Subgraphs",
    href: "/submodels",
    desc: "Capability-rooted subgraphs, cross-submodel couplings, one-way attachments, and boundary review.",
  },
];
      ...
      <Section title="Review Discipline">
        <BulletList
          items={[
            ...
            "Model cross-subgraph contract reuse with one-way attachments.",
