...
pub static RELATION_TYPES: LazyLock<FxHashMap<&'static str, RelationTypeInfo>> =
    LazyLock::new(|| {
        ...
        // SKOS concept relations
        m.insert(
            "broader",
            RelationTypeInfo {
                name: "broader",
                opposite: Some("narrower"),
                description: "SKOS broader concept relation",
                arrow: "-.->",
                label: "broader",
            },
        );
        m.insert(
            ...
            RelationTypeInfo {
                name: "narrower",
                opposite: Some("broader"),
                description: "SKOS narrower concept relation",
                arrow: "-.->",
                label: "narrower",
            },
        );
        m.insert(
            ...
            RelationTypeInfo {
                name: "related",
                opposite: Some("related"),
                description: "SKOS related concept relation",
                arrow: "-.->",
                label: "related",
            },
        );
        m.insert(
            ...
            RelationTypeInfo {
                name: "exactMatch",
                opposite: None,
                description: "SKOS exactMatch concept mapping relation",
                arrow: "-.->",
                label: "exactMatch",
            },
        );
        m.insert(
            ...
            RelationTypeInfo {
                name: "closeMatch",
                opposite: None,
                description: "SKOS closeMatch concept mapping relation",
                arrow: "-.->",
                label: "closeMatch",
            },
        );
...
pub const MODEL_TRAVERSAL_RELATIONS: &[&str] = &[
    ...
    "constrainedBy",
    "use",
    "narrower",   // Concept taxonomy from broader to narrower terms
    "related",    // Concept association
    "exactMatch", // Concept mapping
...
pub const BACKWARD_RELATIONS: &[&str] = &[
    ...
    "broader",     // Opposite of narrower
    "related",     // Symmetric concept association
    "exactMatch",  // Concept mapping
    "closeMatch",  // Concept mapping
...
pub enum LinkType {
    ...
    InternalPath(PathBuf), // Internal Path, e.g., "../crates/reqvire-core/src/digrams.rs"
}
impl LinkType {
...
/// - verifiedBy: Source must be requirement, target must be concrete verification
/// - verify: Source must be concrete verification, target must be requirement
...
pub fn validate_relation_element_types(
    ...
    match relation_type {
        ...
        "exactMatch" | "closeMatch" => matches!(source_type, ElementType::Concept),
...
pub fn get_relation_element_type_description(relation_type: &str) -> Option<String> {
    match relation_type {
        "derivedFrom" => Some("'derivedFrom' can only be used within compatible hierarchy/context families: capability-to-capability, requirement-to-requirement, ontology-to-ontology, concept-to-concept-scheme/concept, or verification-family-to-verification-family. Concept schemes are standalone roots and own concept_base/concept_prefix directly.".to_string()),
        "derive" => Some("'derive' can only be used within compatible hierarchy/context families: capability-to-capability, requirement-to-requirement, ontology-to-ontology, concept-scheme/concept-to-concept, or verification-family-to-verification-family. Concept schemes are standalone roots and own concept_base/concept_prefix directly.".to_string()),
        ...
        "verifiedBy" => Some("'verifiedBy' should connect a requirement to a concrete verification element; capabilities are verified through requirement coverage rollup and verification-objective is not allowed".to_string()),
        "verify" => Some("'verify' should connect a concrete verification element to a requirement; capabilities are verified through requirement coverage rollup and verification-objective is not allowed".to_string()),
        ...
        "exactMatch" => Some("'exactMatch' should map a concept to an equivalent concept IRI or concept element".to_string()),
        "closeMatch" => Some("'closeMatch' should map a concept to a closely matching concept IRI or concept element".to_string()),
        _ => None
    }
}
