...
CRITICAL: Run `/reqvire:setup` to ensure both the plugin and Reqvire npm runner are up to date.
...
Version policy:
- Use `@reqvire-org/reqvire@latest` by default for Claude plugin workflows.
