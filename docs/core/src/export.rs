...
/// Page descriptions for supporting HTML export report pages.
...
"#,
    ...
    info!("Generating knowledgegraph.html...");
    let knowledge_graph_page =
        crate::html::generate_knowledge_graph_page(&temp_model_manager.graph_registry, "");
    fs::write(temp_dir.join("knowledgegraph.html"), knowledge_graph_page)?;
    info!("✅ Generated knowledgegraph.html");

    info!("Generating kn2.html...");
    let kn2_page = crate::html::generate_kn2_page(&temp_model_manager.graph_registry, "");
    fs::write(temp_dir.join("kn2.html"), kn2_page)?;
    info!("✅ Generated kn2.html");
