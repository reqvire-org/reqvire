var ReqvireExplorerDesignSystem_48409e = (function(exports, require$$0, reactDom) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: [
          ...
          variant === "ghost" ? "rq-iconbtn--ghost" : "",
          active ? "is-active" : "",
          className
        ].filter(Boolean).join(" "),
  ...
  function ToggleRow({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        ...props,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rq-togglerow__swatch", style: swatchStyle }),
  ...
  const ELEMENT_TYPES = {
    ...
    refinement: { color: "var(--refinement)", shape: "diamond", role: "refinement" },
    verification: { color: "var(--verification)", shape: "square", role: "verification" },
    specification: { color: "var(--specification)", shape: "diamond", role: "specification" },
    "semantic-contract": { color: "var(--semantic-contract)", shape: "diamond", role: "semantic-contract" },
  ...
  function roleColorToken(role) {
    return ROLE_COLOR_TOKENS[role ?? "other"] ?? "--other";
  }
  ...
  function elementRole(type, family) {
    ...
    if (normalizedType.includes("refinement") || normalizedFamily === "refinement" || REFINEMENT_TYPES.has(normalizedType)) {
      return "refinement";
    }
  ...
  function ElementIcon({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: classes, style: iconStyle, title: title ?? type ?? role, "aria-label": type ?? role, ...props, children: isCapability ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rq-elemicon__pip" }) : null });
  }
