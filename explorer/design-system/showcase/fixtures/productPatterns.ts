...
export const FILE_BROWSER_ITEMS = [
  {
    ...
    name: "Capabilities",
    path: "system-model/Capabilities",
    displayPath: "system-model/Capabilities",
    elementCount: 8,
    childCount: 2,
  },
  {
    ...
    name: "Functional",
    path: "system-model/Functional",
    displayPath: "system-model/Functional",
    elementCount: 5,
    childCount: 3,
  },
  {
    ...
    path: "system-model/Capabilities.md",
    displayPath: "system-model/Capabilities.md",
    elementCount: 3,
    childCount: 0,
    selected: true,
    contentHref: "#/content/system-model/Capabilities.md",
  },
  {
    kind: "file",
    id: "requirements-contracts-md",
    name: "Contracts.md",
    path: "system-model/Contracts.md",
    displayPath: "system-model/Contracts.md",
    elementCount: 6,
    childCount: 0,
    contentHref: "#/content/system-model/Contracts.md",
  },
...
export const DETAIL_RELATIONS: DetailRelationItem[] = [
  ...
  },
  {
    ...
    label: "specifiedIn",
    target: {
      id: "system-model/SystemRequirements.md",
      label: "SystemRequirements.md",
      kind: "resource",
      href: "#/content/system-model/SystemRequirements.md",
      external: false,
    },
  },
];

export const DETAIL_ATTACHMENTS: DetailContractBindingItem[] = [
  {
    id: "att-report",
