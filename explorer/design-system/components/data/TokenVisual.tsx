...
const colorTokenSkinX = css`
  ...
  &[data-color-token="--refinement"],
  .ds-token-segment[data-color-token="--refinement"] { --ds-token-color: var(--refinement); }
  &[data-color-token="--refinement-tint"],
  .ds-token-segment[data-color-token="--refinement-tint"] { --ds-token-color: var(--refinement-tint); }
  &[data-color-token="--refinement-ink"],
  .ds-token-segment[data-color-token="--refinement-ink"] { --ds-token-color: var(--refinement-ink); }
  ...
  &[data-color-token="--edge-attach"],
  .ds-token-segment[data-color-token="--edge-attach"] { --ds-token-color: var(--edge-attach); }
