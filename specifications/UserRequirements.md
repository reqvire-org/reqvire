...
graph LR;
  ...
  b7dd9db7a1290b97["Git-Style Diff Output for Format"];
  class b7dd9db7a1290b97 requirement;
  click b7dd9db7a1290b97 "SystemRequirements/Requirements.md#git-style-diff-output-for-format";
  ...
  7d44a9de72f2ed11["Inconsistent Newlines Format Implementation"];
  class 7d44a9de72f2ed11 requirement;
  click 7d44a9de72f2ed11 "SystemRequirements/Requirements.md#inconsistent-newlines-format-implementation";
  974ccf933675ef44 -.->|deriveReqT| 7d44a9de72f2ed11;
  a7bd845c64d1685e["Reserved Subsections Format Implementation"];
  class a7bd845c64d1685e requirement;
  click a7bd845c64d1685e "SystemRequirements/Requirements.md#reserved-subsections-format-implementation";
  ...
  9f473f6e0b993cac["Excess Whitespace Format Implementation"];
  class 9f473f6e0b993cac requirement;
  click 9f473f6e0b993cac "SystemRequirements/Requirements.md#excess-whitespace-format-implementation";
  974ccf933675ef44 -.->|deriveReqT| 9f473f6e0b993cac;
  719bf8b75772947d["Missing Separators Format Implementation"];
  class 719bf8b75772947d requirement;
  click 719bf8b75772947d "SystemRequirements/Requirements.md#missing-separators-format-implementation";
...
The system SHALL provide a unified linting command that by default operates in dry-run mode to report issues without modifying files, while offering a fix flag to apply auto-fixable changes.

#### Details
The linting command SHALL:
- Default to dry-run mode (safe preview without modifications)
- Require explicit `--fix` flag to apply auto-fixable changes
- Support category filtering (`--syntax`, `--redundant-verify`, `--redundant-hierarchy`)
- Report both auto-fixable issues and manual review items separately
- Display clear categorization of issues in output

**Category Behavior:**
- `--syntax`: Syntax and formatting checks (auto-fixable with --fix)
- `--redundant-verify`: Redundant verify relations detection (auto-fixable with --fix)
- `--redundant-hierarchy`: Maybe-redundant hierarchical relations (manual review only, never auto-fixed)
- No flags: All categories checked
