...
#### Relations
  * verify: [Element Manipulation File Persistence](../ModelManagement/ElementManipulation.md#element-manipulation-file-persistence)
...
#### Relations
  * verify: [Target Location Validation and Auto-Creation](../ModelManagement/ElementManipulation.md#target-location-validation-and-auto-creation)
...
#### Relations
  * verify: [Create Element Operation](../ModelManagement/ElementManipulation.md#create-element-operation)
...
#### Relations
  * verify: [Delete Element Operation](../ModelManagement/ElementManipulation.md#delete-element-operation)
  * satisfiedBy: [test.sh](../../tests/test-crud-manipulation/test.sh)
---
...
#### Relations
  * verify: [Relation Consistency Maintenance](../ModelManagement/ElementManipulation.md#relation-consistency-maintenance)
...
#### Relations
  * verify: [CLI Add Element Command](../UserInterface/CLI.md#cli-add-element-command)
  * satisfiedBy: [test.sh](../../tests/test-crud-manipulation/test.sh)
---
...
#### Relations
  * verify: [CLI Remove Element Command](../UserInterface/CLI.md#cli-remove-element-command)
  * satisfiedBy: [test.sh](../../tests/test-crud-manipulation/test.sh)
---
...
#### Relations
  * verify: [CLI Move Element Command](../UserInterface/CLI.md#cli-move-element-command)
  * satisfiedBy: [test.sh](../../tests/test-crud-manipulation/test.sh)
---
...
#### Relations
  * verify: [CLI Rename Element Command](../UserInterface/CLI.md#cli-rename-element-command)
  * satisfiedBy: [test.sh](../../tests/test-crud-manipulation/test.sh)
---
...
#### Relations
  * verify: [CLI Move File Command](../UserInterface/CLI.md#cli-move-file-command)
  * satisfiedBy: [test.sh](../../tests/test-crud-manipulation/test.sh)
