...
#### Relations
  * verify: [Change Impact Detection Algorithm](../ModelManagement/ChangeImpact.md#change-impact-detection-algorithm)
  * verify: [Change Impact Command Line Interface](../ModelManagement/ChangeImpact.md#change-impact-command-line-interface)
...
#### Relations
  * verify: [CLI Git Commit Hash Flag](../UserInterface/CLI.md#cli-git-commit-hash-flag)
  * satisfiedBy: [test.sh](../../tests/test-change-impact-detection/test.sh)
---
