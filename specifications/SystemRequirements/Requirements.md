...
graph LR;
  ...
  click 63f1cd4974cbf62 "Requirements.md#git-style-diff-output-for-linting";
  ...
  click 8b47697e4e9fce62 "../../core/src/linting/mod.rs";
  8b47697e4e9fce62 -->|satisfies| 63f1cd4974cbf62;
  fffbb227966be4f2["CLI Lint Flag"];
  click fffbb227966be4f2 "Requirements.md#cli-lint-flag";
  ...
  click 8f2198f681f63fea "Requirements.md#dry-run-mode";
  ...
  click 193cd6463891423e "Requirements.md#reserved-subsections-linting-implementation";
  ...
  click 3aaafb0eaf60961c "../../core/src/linting/indentation.rs";
  3aaafb0eaf60961c -->|satisfies| 193cd6463891423e;
  45770e9b319d3819["File Pattern Exclusion for Linting"];
  click 45770e9b319d3819 "Requirements.md#file-pattern-exclusion-for-linting";
  ...
  click cc8128cae305b29d "Requirements.md#configurable-filename-exclusion-patterns";
  45770e9b319d3819 -->|refines| cc8128cae305b29d;
  3189923c3f5e2124["utils.rs"];
  class 3189923c3f5e2124 default;
  click 3189923c3f5e2124 "../../core/src/utils.rs";
  3189923c3f5e2124 -->|satisfies| 45770e9b319d3819;
  dd0846393d037337["Missing Separators Linting Implementation"];
  click dd0846393d037337 "Requirements.md#missing-separators-linting-implementation";
  ...
  click 9abe404e42ed3086 "../../core/src/linting/separators.rs";
  9abe404e42ed3086 -->|satisfies| dd0846393d037337;
  3f3d3f9ccb15029a["Excess Whitespace Linting Implementation"];
  click 3f3d3f9ccb15029a "Requirements.md#excess-whitespace-linting-implementation";
  ...
  click bb06efd0b85636ec "../../core/src/linting/whitespace.rs";
  bb06efd0b85636ec -->|satisfies| 3f3d3f9ccb15029a;
  f98ae394dbbde42c["Incosistent Newlines Linting Implementation"];
  click f98ae394dbbde42c "Requirements.md#incosistent-newlines-linting-implementation";
  ...
  click b52472a7ccc9c395 "../../core/src/linting/newlines.rs";
  b52472a7ccc9c395 -->|satisfies| f98ae394dbbde42c;
  66aa36deca421516["Parallel Linting Processing"];
  click 66aa36deca421516 "Requirements.md#parallel-linting-processing";
...
graph LR;
  ...
  click d38ab4ad139183d3 "Requirements.md#external-folders-support";
  ...
  click c87fb8d32afb10bb "../../cli/src/config.rs";
...
graph LR;
  ...
  click c8b6ccc187b0a27e "Requirements.md#html-export";
  ...
  click 8cb11d152f3b9d2d "../../core/src/html_export.rs";
  8cb11d152f3b9d2d -->|satisfies| c8b6ccc187b0a27e;
  bdfd9d65e46117e7["Detailed Error Handling and Logging"];
  click bdfd9d65e46117e7 "Requirements.md#detailed-error-handling-and-logging";
  ...
  click 8cd8a561b4c440e3 "../../core/src/error.rs";
  8cd8a561b4c440e3 -->|satisfies| bdfd9d65e46117e7;
  5870488e00ee4f36["Relation Type Validation"];
  click 5870488e00ee4f36 "Requirements.md#relation-type-validation";
  ...
  click ed4f94bde93b51b2 "../../core/src/relation.rs";
  ed4f94bde93b51b2 -->|satisfies| 5870488e00ee4f36;
  98bd2bd6bdf5bf97["File Content Caching for Performance"];
  click 98bd2bd6bdf5bf97 "Requirements.md#file-content-caching-for-performance";
  ...
  click 6136c216c9f80165 "../../core/src/model.rs";
  6136c216c9f80165 -->|satisfies| 98bd2bd6bdf5bf97;
  8acd24c7c228637b["Index Generation"];
  click 8acd24c7c228637b "Requirements.md#index-generation";
  ...
  click 3ef6afafe29becbc "../../core/src/index_generator.rs";
  3ef6afafe29becbc -->|satisfies| 8acd24c7c228637b;
  8ba9c7e059799274["LLM Context Command"];
  click 8ba9c7e059799274 "Requirements.md#llm-context-command";
  ...
  click 4a5edefd6e054300 "../../cli/src/main.rs";
  4a5edefd6e054300 -->|satisfies| 8ba9c7e059799274;
  5ec6a2668bddf0e["JSON Output Format"];
  click 5ec6a2668bddf0e "Requirements.md#json-output-format";
  ...
  click c5c85bedd1cf11e6 "Requirements.md#excluded-file-relation-validation";
  class c5c85bedd1cf11e6 requirement;
  45770e9b319d3819["File Pattern Exclusion for Linting"];
  class 45770e9b319d3819 requirement;
  click 45770e9b319d3819 "Requirements.md#file-pattern-exclusion-for-linting";
  c5c85bedd1cf11e6 -->|refines| 45770e9b319d3819;
  3b1e87396caf6495["src/parser.rs"];
  class 3b1e87396caf6495 default;
  click 3b1e87396caf6495 "../../core/src/parser.rs";
  3b1e87396caf6495 -->|satisfies| c5c85bedd1cf11e6;
  5a1719a2649b9922["Unstructured Documents"];
  click 5a1719a2649b9922 "Requirements.md#unstructured-documents";
  ...
  click 86e0701b6ce7de0b "Requirements.md#html-navigation-enhancement";
  ...
  click c788e5b84faa2ae3 "../../core/src/html.rs";
  ...
  click 7a8da8dfee910932 "Requirements.md#interactive-mermaid-diagram-node-behavior";
  ...
  click d4240e29691d4b88 "../../core/src/diagrams.rs";
...
graph LR;
  ...
  click 2737f2d770aa0757 "Requirements.md#requirements-files-search-and-detection";
  ...
  click 99bed90a0d96a1d2 "Requirements.md#requirements-processing";
...
graph LR;
  ...
  click c826c1ee7c93bf6b "Requirements.md#sysml-compatible-relationship-rendering";
  ...
  click 191d27287e362df2 "Requirements.md#diagram-storage-path-configuration";
  ...
  click a7ec66314a62423b "Requirements.md#mermaid-diagram-format-conversion";
  ...
  click 1414e7f8890f2939 "Requirements.md#relationship-type-filter-implementation";
  ...
  click 9860815d52cb0fbb "Requirements.md#visual-differential-rendering";
...
graph LR;
  ...
  click 918cc4a26d642f30 "Requirements.md#structural-change-analyzer";
  ...
  click d7e5fbf806d650d9 "Requirements.md#markdown-matrix-formatter";
  ...
  click 5eca866a0338e0fe "Requirements.md#traceability-matrix-builder-implementation";
  class 5eca866a0338e0fe requirement;
  5eca866a0338e0fe -.->|deriveReqT| ba40352f8e72c125;
  83a2343e97857828["Matrix File Output Handler"];
  click 83a2343e97857828 "Requirements.md#matrix-file-output-handler";
  class 83a2343e97857828 requirement;
  c4b025f6ac8438c7["UserRequirements.md/Save matrices to designated files"];
  class c4b025f6ac8438c7 requirement;
  click c4b025f6ac8438c7 "../UserRequirements.md#save-matrices-to-designated-files";
  83a2343e97857828 -.->|deriveReqT| c4b025f6ac8438c7;
  8897111f9b3656ce["Matrix Export Format Handler"];
  click 8897111f9b3656ce "Requirements.md#matrix-export-format-handler";
  class 8897111f9b3656ce requirement;
  4b7b4328173caada["UserRequirements.md/Export Traceability Matrix"];
  class 4b7b4328173caada requirement;
  click 4b7b4328173caada "../UserRequirements.md#export-traceability-matrix";
  8897111f9b3656ce -.->|deriveReqT| 4b7b4328173caada;
  b8b40184613535c1["CLI Git Commit Hash Flag"];
  click b8b40184613535c1 "Requirements.md#cli-git-commit-hash-flag";
...
graph LR;
  ...
  click 212d1317cd2b25fc "Requirements.md#relation-element-type-validator";
  ...
  click a34d9281a02c6839 "../SpecificationsRequirements.md#relation-types-specifications";
  ...
  click c7d88aff4ec97281 "Requirements.md#cross-component-dependency-validator";
  ...
  click 887db62e0fb2818d "Requirements.md#markdown-structure-validator";
  ...
  click 1c2e7c81f9f01e10 "Requirements.md#internal-consistency-validator";
  ...
  click ec201a112c9de469 "Requirements.md#filesystem-structure-validator";
...
graph LR;
  ...
  d842bc0e30a46408["Verification Gap Analyzer"];
  click d842bc0e30a46408 "Requirements.md#verification-gap-analyzer";
  class d842bc0e30a46408 requirement;
  ...
  d842bc0e30a46408 -.->|deriveReqT| d0e9e8d143493413;
  2ccb7e551054d40a["Report Export Formatter"];
  click 2ccb7e551054d40a "Requirements.md#report-export-formatter";
  class 2ccb7e551054d40a requirement;
  2afa7f3a206a61b7["UserRequirements.md/Export Reports to Standard Formats"];
  class 2afa7f3a206a61b7 requirement;
  click 2afa7f3a206a61b7 "../UserRequirements.md#export-reports-to-standard-formats";
  2ccb7e551054d40a -.->|deriveReqT| 2afa7f3a206a61b7;
  cccd4e46e2b3239a["Model Summary Report Generator"];
  click cccd4e46e2b3239a "Requirements.md#model-summary-report-generator";
  ...
  click 6292255058880ee6 "../../core/src/reports.rs";
  6292255058880ee6 -->|satisfies| cccd4e46e2b3239a;
  6f86272134897867["CLI Summary Report Flag"];
  click 6f86272134897867 "Requirements.md#cli-summary-report-flag";
  ...
  57cbef16c5d7a81d["Dependency Report Generator"];
  click 57cbef16c5d7a81d "Requirements.md#dependency-report-generator";
  class 57cbef16c5d7a81d requirement;
  812d42f453051272["UserRequirements.md/Generate Dependency Reports"];
  class 812d42f453051272 requirement;
  click 812d42f453051272 "../UserRequirements.md#generate-dependency-reports";
  57cbef16c5d7a81d -.->|deriveReqT| 812d42f453051272;
  143766be8cc41384["Validation Report Generator"];
  click 143766be8cc41384 "Requirements.md#validation-report-generator";
