...
pub enum Commands {
    ...
    Link {
        ...
        /// Relations: derivedFrom, derive, specify, specifiedBy, define, definedBy, constrain, constrainedBy, use, usedBy, satisfiedBy, satisfy, verifiedBy, verify.
...
pub async fn handle_command(
    ...
    match args.command {
        ...
        Some(Commands::Ontologies {
            ...
            let output_content = index.serialize_with_options(format, full, include_external)?;
            if let Some(path) = output {
